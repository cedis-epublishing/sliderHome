(function() {
  ...
  var _sfc_render = function render() {
    ...
    return _c("div", { staticClass: "sliderHomeListPanel", class: { "-isOrdering": _vm.isOrdering } }, [_c("pkp-list-panel", { attrs: { "items": _vm.items, "title": "title" }, scopedSlots: _vm._u([{ key: "item-title", fn: function({ item }) {
      return [item.thumbnail ? _c("img", { staticClass: "sliderThumbnail", attrs: { "alt": _vm.thumbnailDescription, "src": item.thumbnailUrl } }) : _vm._e(), _c("pkp-badge", { attrs: { "isSuccess": item.show_content } }, [item.show_content ? _c("pkp-icon", { attrs: { "icon": "fa-light fa-eye", "inline": true } }) : _vm._e(), _vm._v(" " + _vm._s(item.name) + " ")], 1)];
