{* <tab id="sliderHome" label="{translate key="plugins.generic.sliderHome.tabname"}">
	{capture assign=sliderHomeGridUrl}{url router=$smarty.const.ROUTE_COMPONENT component="plugins.generic.sliderHome.classes.components.form.context.sliderhomesettingsform" op="index" escape=false}{/capture}
