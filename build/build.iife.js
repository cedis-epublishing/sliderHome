(function() {
  ...
  const _sfc_main = {
    ...
    methods: {
       ...
       * Open the modal to add an item
       */
      openAddFromPublicationModal() {
        this.resetFocusTo = document.activeElement;
        let activeForm = cloneDeep$1(this.addPublicationForm);
        activeForm.action = this.apiUrl;
        activeForm.method = "POST";
        this.activeForm = activeForm;
        this.activeFormTitle = this.addFromPublicationSliderLabel;
        this.$modal.show("form");
      },
      /**
       * Open delete modal
  ...
  var _sfc_render = function render() {
    ...
    return _c("div", { staticClass: "sliderHomeListPanel", class: { "-isOrdering": _vm.isOrdering } }, [_c("pkp-list-panel", { attrs: { "items": _vm.items, "title": "title" }, scopedSlots: _vm._u([{ key: "item-title", fn: function({ item }) {
      return [item.thumbnail ? _c("img", { staticClass: "sliderThumbnail", attrs: { "alt": _vm.thumbnailDescription, "src": item.thumbnailUrl } }) : _vm._e(), _c("pkp-badge", { staticClass: "sliderCenterVert", attrs: { "isSuccess": item.show_content } }, [item.show_content ? _c("pkp-icon", { attrs: { "icon": "fa-light fa-eye", "inline": true } }) : _vm._e(), _vm._v(" " + _vm._s(item.name) + " ")], 1)];
    ...
    } } }, [_vm._v(" " + _vm._s(_vm.__("common.cancel")) + " ")])], _c("pkp-button", { ref: "addSliderButton", staticStyle: { "float": "right" }, attrs: { "disabled": _vm.isOrdering }, on: { "click": _vm.openAddModal } }, [_vm._v(" " + _vm._s(_vm.addSliderLabel) + " ")]), _c("pkp-button", { ref: "addFromPublicationSliderButton", staticStyle: { "float": "right" }, attrs: { "disabled": _vm.isOrdering }, on: { "click": _vm.openAddFromPublicationModal } }, [_vm._v(" " + _vm._s(_vm.addFromPublicationSliderLabel) + " ")])], 2)], 2), _vm._v(_vm._s(_vm.items.length) + " ")], 1), _c("pkp-modal", { attrs: { "closeLabel": _vm.__("common.close"), "name": "form", "title": _vm.activeFormTitle }, on: { "closed": _vm.formModalClosed } }, [_c("pkp-form", _vm._b({ on: { "set": _vm.updateForm, "success": _vm.formSuccess } }, "pkp-form", _vm.activeForm, false))], 1)], 1);
  };
